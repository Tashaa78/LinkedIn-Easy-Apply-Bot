...
if useGUI == False:
    ...
    location = 'Germany'  # location where to apply (e.g. Barcelona)
...
if useGUI == True:
    ...
    print(username, password, language, position,
          location_code, location, resumeloctn)


# start bot
bot = EasyApplyBot(username, password, language,
                   position, location, resumeloctn)
bot.start_apply()
